#!/usr/bin/env python3
# -----------------------------------------------------------
### Reproducibility script for: "Non-Hermitian effects in the Su-Schrieffer-Heeger model: Exploring substrate coupling and decoupling dynamics"
### You can access the article at [Phys. Rev. B.](https://journals.aps.org/prb/accepted/10.1103/xjy9-6ysw) (DOI: 10.1103/xjy9-6ysw)
### This script provides the code required to plot the Figure 7 of the above article.
